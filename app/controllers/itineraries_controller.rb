class ItinerariesController < ApplicationController
  ...
  def index
    ...
    @itineraries = Tour.find(params[:tour_id]).itinerary
  end
  ...
  # GET /itineraries/new
  def new
    @itinerary = @tour.itinerary.build
  end
  ...
  def create
    @itinerary = @tour.itinerary.new(itinerary_params)

    respond_to do |format|
      if @itinerary.save
        format.html { redirect_to tour_itineraries_path, notice: 'Itinerary was successfully created.' }
  ...
  private
    ...
    def itinerary_params
      params.require(:itinerary).permit(:tour_id, :place_id)
    end
end
